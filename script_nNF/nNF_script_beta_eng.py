...
print(f'\n\nTime:\t{str(end - start)}')
print(f'\n\nLargest Number: {largest_nNF}')
print(f'Smallest Number: {smallest_nNF}')
print(f'Missing Numbers: {missing_nNF_numbers_list}')
print(f'Amount of Missing Numbers: {len(missing_nNF_numbers_list)}\n\n')
